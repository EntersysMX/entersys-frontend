...
export function WorksysLayout504() {
  return (
        ...
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
              Características de Worksys
            </h1>
            <p className="md:text-md">
              Simplificamos la complejidad operativa con soluciones tecnológicas
              que convierten procesos manuales en sistemas inteligentes y
              eficientes.
            </p>
          ...
          >
            <Card className="grid grid-cols-1 md:grid-cols-2 md:items-center">
              ...
              <div className="p-6 md:p-8 lg:p-12">
                <p className="mb-3 font-semibold md:mb-4">Tecnología</p>
                <h2 className="mb-5 text-4xl leading-[1.2] font-bold md:mb-6 md:text-5xl lg:text-6xl">
                  Digitalización de procesos con Smartsheet
                </h2>
                <p>
                  Automatizamos flujos de trabajo utilizando Smartsheet para
                  mejorar la productividad y reducir errores humanos.
                </p>
                <div className="mt-6 flex items-center gap-x-4 md:mt-8">
                  <Button title="Conocer más" variant="secondary">
                    Conocer más
                  </Button>
                  <Button
                    title="Ver detalles"
