          ...
          <Card className="flex w-full flex-col items-start justify-between p-6 md:p-8">
            <div className="rb-5 mb-5 md:mb-6">
              ...
              <blockquote className="md:text-md">
                Expersys transformó completamente nuestra gestión de procesos.
              </blockquote>
            </div>
            <div className="mt-5 flex w-full flex-col items-start md:mt-6 md:w-fit md:flex-row md:items-center">
              ...
              <div>
                ...
                <p>Directora, Grupo Empresarial</p>
              </div>
            </div>
          </Card>
          <Card className="flex w-full flex-col items-start justify-between p-6 md:p-8">
            <div className="rb-5 mb-5 md:mb-6">
              ...
              <blockquote className="md:text-md">
                Nunca había visto una implementación tan rápida y efectiva.
              </blockquote>
            </div>
            <div className="mt-5 flex w-full flex-col items-start md:mt-6 md:w-fit md:flex-row md:items-center">
              <img
              ...
              <div>
                ...
                <p>Gerente de Operaciones, Innovación Corp</p>
              </div>
            </div>
          </Card>
          <Card className="flex w-full flex-col items-start justify-between p-6 md:p-8">
            <div className="rb-5 mb-5 md:mb-6">
              ...
              <blockquote className="md:text-md">
                La tecnología de Expersys nos permitió obtener certificaciones
                en tiempo récord.
              </blockquote>
            </div>
            <div className="mt-5 flex w-full flex-col items-start md:mt-6 md:w-fit md:flex-row md:items-center">
              ...
              <div>
                ...
                <p>CEO, Desarrollo Estratégico</p>
              </div>
            </div>
          </Card>
        </div>
