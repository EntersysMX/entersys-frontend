          ...
          <div className="flex flex-col justify-center p-8 md:p-12">
            <div>
              ...
              <p className="text-medium">
                En semanas, no en meses, digitalizamos lo que ya haces bien y lo
                convertimos en información que funciona. Automatizamos controles
                manuales y los transformamos en dashboards que responden en 3
                segundos.
              </p>
            </div>
