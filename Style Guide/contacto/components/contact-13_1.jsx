    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="rb-12 mb-12 max-w-lg md:mb-18 lg:mb-20">
          ...
          <p className="md:text-md">Contáctanos por tu canal preferido</p>
        </div>
        <div className="grid auto-cols-fr grid-cols-1 gap-x-12 gap-y-12 sm:grid-cols-2 md:gap-x-20 md:gap-y-16 lg:grid-cols-[0.5fr_1fr]">
          <div className="grid auto-cols-fr grid-cols-1 gap-x-4 gap-y-10">
            <div>
              ...
              <p className="mb-2">Escríbenos para más información</p>
            ...
            <div>
              ...
              <p className="mb-2">Llámanos cuando necesites</p>
              <a className="underline" href="#">
                +52 55 1234 5678
              </a>
            </div>
            <div>
              ...
              <p className="mb-2">Visítanos en nuestra oficina principal</p>
